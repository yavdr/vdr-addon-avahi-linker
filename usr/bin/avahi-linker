...
class Config:
    def __init__(self, options):
        ...
        parser.read([os.path.join(configdir, 'staticmount.cfg'), os.path.join(configdir, 'localdirs.cfg')])
